...
projet, à relire au début de chaque séance de travail.
...
1. Fond et architecture (DECISIONS.md, arborescence, spec.md, data.json)
...
## Points soumis à la décision de Tony
